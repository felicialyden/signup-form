...
function Arcade(props) {
  function handleSelect() {
    document.getElementById("arcade").classList.add("selected");
  ...
  return (
    <div
      className="plan-container flex-column align-left"
      id="arcade"
    ...
    >
      ...
      <div className="plan-specifics">
        <p className="plan dark-blue">Arcade</p>
        <p className="plan-pricing grey">
          {" "}
          {props.timeFrame === "Monthly" ? "$9/mo" : "$90/yr"}
        </p>
        <p className="offer dark-blue">
          {props.timeFrame === "Monthly" ? "" : "2 months free"}
        </p>
      </div>
    </div>
  );
...
function Advanced(props) {
  function handleSelect() {
    document.getElementById("arcade").classList.remove("selected");
  ...
  return (
    <div
      className="plan-container flex-column"
      id="advanced"
      onClick={handleSelect}
    >
      <svg
      ...
      <div className="plan-specifics">
        <p className="plan dark-blue">Advanced</p>
        <p className="plan-pricing grey">
          {" "}
          {props.timeFrame === "Monthly" ? "$12/mo" : "$120/yr"}
        </p>
        <p className="offer dark-blue">
          {props.timeFrame === "Monthly" ? "" : "2 months free"}
        </p>
...
function Pro(props) {
  ...
  return (
    <div className="plan-container flex-column" id="pro" onClick={handleSelect}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="40"
        height="40"
      ...
      <div className="plan-specifics">
        <p className="plan dark-blue">Pro</p>
        <p className="plan-pricing grey">
          {" "}
          {props.timeFrame === "Monthly" ? "$15/mo" : "$150/yr"}
        </p>
        <p className="offer dark-blue">
          {props.timeFrame === "Monthly" ? "" : "2 months free"}
        </p>
...
export function Planselector(props) {
  function handlePlanState(planStateValue) {
    props.plan(planStateValue);
  }
  return (
    <div id="plan-selector" className="flex-row">
      <Arcade timeFrame={props.timeFrame} plan={handlePlanState} />
      <Advanced timeFrame={props.timeFrame} plan={handlePlanState} />
      <Pro timeFrame={props.timeFrame} plan={handlePlanState} />
    </div>
  );
}
